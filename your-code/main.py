...
#no se puede hacer esa operacion con espacios vectoriales de distintas dimensiones 
...
array([[[ 75.,  75.,  75.,  25.,  75.],
       ...
       [[ 25.,  25.,  25.,  25., 100.],
        ...
        [ 25.,  75.,   0.,  75.,  75.]]])
"""
print("[  #17- Matrix d]".center(50,"="))
print(f"\n {d}")
print("[  #17- Matrix f]".center(50,"="))
print(f"\n {f}")
...
g[(d_mean > d) & (d > d_min)] = "A"
g[(d_max > d) & (d > d_mean)] = "B"
g[d == d_mean] = "C"
g[d == d_max] = "D"
g[d == d_min] = "E"
print(f"\n {g}")
